        ...
        <div className="px-6 sm:px-8 lg:px-12 py-8 sm:py-12 lg:py-16">
            ...
            <div className="space-y-4 sm:space-y-6 text-center sm:text-left">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="flex items-start space-x-3 justify-center sm:justify-start">
                  ...
                  <span className="text-white/70 text-xs sm:text-sm">Málaga, Spain</span>
                </div>
                <div className="flex items-start space-x-3 justify-center sm:justify-start">
                  <div className="w-4 h-4 sm:w-5 sm:h-5 bg-white/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-between space-y-4 sm:space-y-0">
            <div className="text-center">
              <p className="text-white/60 text-xs">
                © 2025 Growthwebs. All rights reserved.
              </p>
            </div>
            <div className="flex items-center space-x-4 sm:space-x-6">
              <a href="/privacy-policy" className="text-white/60 hover:text-white/80 transition-colors duration-300 text-xs">
                Privacy Policy
              </a>
              <a href="/terms-of-service" className="text-white/60 hover:text-white/80 transition-colors duration-300 text-xs">
                Terms of Service
              </a>
              <a href="/cookie-policy" className="text-white/60 hover:text-white/80 transition-colors duration-300 text-xs">
                Cookie Policy
              </a>
            </div>
          </div>
          ...
          <div className="text-center mt-6 sm:mt-8 lg:mt-12">
            <p className="text-white/50 text-xs">
              Built by <a href="https://www.growthwebs.com" target="_blank" rel="noopener noreferrer" className="font-semibold text-white hover:text-cosmic transition-colors duration-300">growthwebs</a>
            </p>
          </div>
        </div>
      </div>
