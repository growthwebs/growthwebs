...
export const metadata: Metadata = {
  ...
  description: 'Transform your business with GrowthWebs. Expert web design, frontend & backend development, technical & strategic SEO, conversion optimization, and performance optimization. We build high-converting websites that drive measurable business growth.',
  keywords: [
